...
namespace Art_Assignment.Pages.Profile
{
    public partial class User : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            UserDataSource.SelectCommand = "SELECT COALESCE(Name, FORMAT(ID, 'User\\#000#')) AS Name,COALESCE(FirstName, '&lt;not set&gt;') AS FirstName,COALESCE(LastName, '&lt;not set&gt;') AS LastName,COALESCE(convert(varchar, DateBirth, 105), '&lt;not set&gt;') AS DateBirth, Email FROM [User] WHERE ID = @ID";
